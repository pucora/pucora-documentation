...
[Keycloak](https://www.keycloak.org/) is an Open Source **Identity and Access Management** project, sponsored by RedHat. The Velonetics configuration for Keycloak relies internally on the [JWT validation](/docs/authorization/jwt-validation/) component.
