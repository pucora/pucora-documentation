...
description: Explore the supported formats for Pucora configuration. Find the best fit for your API Gateway setup
menu:
  community_current:
...
The expected configuration file format by default is `json`, but Pucora can parse any of these file formats:
...
You can validate the syntax of any of these with [`pucora check`](/docs/configuration/check/)
...
- **Using the UI**: If you intend to generate or edit your configuration file using the [Pucoraesigner](https://designer.pucora.io), the input and output are always a `.json` file.
