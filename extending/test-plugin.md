...
When you upgrade Velonetics to another version you must recompile your plugins using the [builder matching the version](/docs/extending/writing-plugins/#plugin-builder).
{{< /note >}}
