...
- **Using the UI**: If you intend to generate or edit your configuration file using the [Pucoraesigner](https://designer.pucora.in), the input and output are always a `.json` file.
